...
const ServiceCard = ({ id, image, bigHeading, smallHeading, content }) => {
    return (
        <div className=' flex flex-col items-center justify-between shadow-shadow4 bg-white_new-0 text-black lg:w-1/4 w-full lg:h-[23rem] h-[25rem] border-4 border-purple-400 lg:p-3 p-4 lg:m-3 mb-7 rounded-xl'>
            ...
            <p className='text-center text-wrap lg:text-lg text-lg font-poppins h-2/5 p-2 lg:p-0'>{content}</p>
